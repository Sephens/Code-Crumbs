...
2. **Step 1: Create a KMS Key**
   - Go to the AWS Management Console.
    ![kms](/public/BL-10244/278-1.png)
   - Navigate to **KMS > Customer managed keys > Create key**.
    ![kms-create](/public/BL-10244/278-2.png)
   - Choose **Symmetric** as the key type.
    ![kms-keytype](/public/BL-10244/278-3.png)
   - On the Add labels page, you can add a label and a decription toyour key as follows:
    ![kms-addlabel](/public/BL-10244/278-4.png)  
   - Define key usage permissions using IAM policies.
    ![kms-permissions](/public/BL-10244/278-5.png)
    ![kms-permissions](/public/BL-10244/278-6.png)
   - Complete the key creation process.
    ![kms-finish](/public/BL-10244/278-7.png)
    ![kms-finish](/public/BL-10244/278-8.png)
...
3. **Step 2: Configure the File Server instance** 
   ...
   - In the console, enter EC2 in the search  bar, and then choose EC2.
    ![ec2](/public/BL-10244/278-11.png)
...
5. **Step 4: Integrate KMS with S3**
   - Create an S3 bucket.
   - Enable default encryption for the bucket using your KMS key.
   - Upload a file to the bucket and verify that it is encrypted.

6. **Step 5: Monitor Key Usage with AWS CloudTrail**

    ...
    <div className="min-h-screen relative bg-white dark:bg-gray-900">
      ...
      <div className="max-w-2xl pt-20 pb-32 px-6 text-center mx-auto">
        ...
        <p className="text-gray-600 mt-4 dark:text-indigo-200">
          I am an Undergraduate holding a Bachelors Degree in Information Technology Second Class (Upper Division). My field of Interest's are building new Web
        ...
        <div className="text-center pt-8">
          <button className="bg-green-500 px-3 py-1 font-semibold text-white inline-flex items-center space-x-2 rounded dark:bg-green-600">
            ...
            <a
              ...
              target="_blank"
              href="https://portfolio-lake-five-68.vercel.app/"
            >
              See My Works
            </a>
          </button>
